...
public class VerifyCourseTest extends Base {
	...
	@Test
	public void courseTitle() throws IOException, InterruptedException {

		LandingPage lanp = new LandingPage(driver);
		Assert.assertEquals(lanp.getcourseTitle().getText(), "FEATURED COURSES123");
		log.info("Course title is successfully verified");
	}
